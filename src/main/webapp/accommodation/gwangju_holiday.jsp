...
<body>
   ...
   <section class="main-section1">
      <section id="hotel">
        ...
        <div class="content">
          <div class="photo1">
            <img src="/hotel/images/gwangju_holiday.jpg" alt="광주호텔" style="border: 1px solid white; border-radius: 50%"/>
          	<div class="photo2" style="border: 1px solid white; border-radius: 50%;overflow:hidden;">
          		<jsp:include page="gwangju_api.html"></jsp:include>
          	</div>
          </div>
          <div class="text1">
            <ol>
